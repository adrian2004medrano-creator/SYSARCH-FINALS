...
function Homepage({ faqs, chatbotEntries }) {
  ...
  // ✅ NEW: Check Incident Status handler
      ...
      <main className="homepage-content">
        <Row className="homepage-main-row">
              ...
              <Card.Body>
                ...
                <Card.Text className="description-text">
                  ...
                  <ul>
                    ...
                    <li><strong>Check status of your reports</strong></li>
          ...
          <Col md={8} className="homepage-actions-col">
            {/* ✅ QUICK ACTIONS - UPDATED WITH CHECK STATUS BUTTON */}
            <section className="homepage-actions">
              <h4 className="section-title">Quick Actions</h4>
              <Row>
                {/* ✅ NEW: Check Incident Status - PINAKA-TAAS */}
                <Col md={4} className="mb-4">
                  <Card className="action-card status-card">
                    <Card.Body className="text-center">
                      <div className="card-icon status-icon">📋</div>
                      <Card.Title>Check Incident Status</Card.Title>
                      <Card.Text className="text-center">
                        Track the status of your reported incidents and complaints
                      </Card.Text>
                      <Button
                        variant="success"
                        size="lg"
                        className="w-100 status-btn"
