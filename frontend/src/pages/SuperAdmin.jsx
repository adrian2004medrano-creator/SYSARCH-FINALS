...
function SuperAdmin() {
  ...
  const handleCreateAdmin = () => navigate("/create-admin");
      ...
      <Body>
        <div className="d-flex justify-content-center align-items-center min-vh-100">
          <div className="text-center">
            ...
            <p className="mb-0">Loading Super Admin Dashboard...</p>
          </div>
        </div>
      </Body>
    );
    ...
    <Body>
      <div className="superadmin-dashboard">
        ...
        <section className="stats-section mb-5">
          <h3 className="section-title mb-4">Dashboard</h3>
          <Row>
            ...
            <Col md={6} lg={4} className="mb-4">
              <Card className="stat-card clickable h-100" onClick={handlePublicStatus}>
                <Card.Body className="text-center">
                  ...
                  <Card.Title className="mt-2">Ongoing Incident/Complaint</Card.Title>
                  <Card.Text className="lead fw-bold text-info fs-3">
                    {stats.incidents.total || 0} Total
                  </Card.Text>
                  <small className="text-muted">Check the ongoing Incidents and Complaints (Open cases only)</small>
                </Card.Body>
              </Card>
            </Col>
              ...
              <Card className="stat-card clickable h-100" onClick={handleManageIncidents}>
                <Card.Body className="text-center">
                  ...
                  <Card.Title className="mt-2">
                    <strong>Incident/Complaint Management</strong>
                  </Card.Title>
                  <Card.Text className="display-6 fw-bold text-warning mb-1">
                    Manage Incident
                  </Card.Text>
                  <small className="text-muted">
                    Update status, view records, mark solved
                  </small>
                </Card.Body>
              </Card>
            </Col>
        ...
        <section className="charts-section mb-5">
          <h3 className="section-title mb-4">Statistics</h3>
          <Row>
        ...
        <section className="management-section">
          <h3 className="section-title mb-4">Quick Management Actions</h3>
          <Row>
            <Col md={6} lg={4} className="mb-4">
              <Card className="management-card h-100">
                <Card.Body>
                  <div className="card-icon admin">🛠️</div>
                  <Card.Title>Create Admin Account</Card.Title>
                  <Card.Text>
                    Super Admins can create new Barangay Admin accounts here.
                  </Card.Text>
                  <Button 
                    variant="primary" 
                    className="w-100"
            ...
            <Col md={6} lg={4} className="mb-4">
              <Card className="management-card h-100">
                <Card.Body>
                  ...
                  <Card.Text>Complete admin control with records view.</Card.Text>
                  <Button 
                    variant="warning" 
                    className="w-100"
            ...
            <Col md={6} lg={4} className="mb-4">
              <Card className="management-card h-100">
                <Card.Body>
                  ...
                  <Card.Text>Post and manage barangay announcements and ordinances.</Card.Text>
                  <Button 
                    variant="secondary" 
                    className="w-100"
